  <?php
        $admin= new Accounts();
        $admin->getFromDB($_SESSION["idClient"]);
?>
                            ...
                            <div class=" form">
                                <form class="cmxform form-horizontal " id="commentForm" action="controller/user_save.php?op=<?php if($_GET["id"]== 0){echo "1";}else{echo "2";}?>&pg=formUser" method="post" enctype="multipart/form-data">
                                    <input type="hidden" value="<?php if($_GET['id']!=0){echo $admin->getId();} ?>" name="id">
                                     <input type="hidden" value="<?php if($_GET['id']!=0){echo $admin->getActive();} else {echo "1";} ?>" name="active">


                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-3">Registration number</label>
                                        <div class="col-lg-6">
