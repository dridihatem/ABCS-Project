...
<div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Add or Update payslip</li>
                    </ul>
                    <!--breadcrumbs end -->
                </div>
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <?php require("msg.php");?>
                            <div class=" form">
                                <form class="cmxform form-horizontal " id="commentForm" action="controller/fiche_save.php?op=<?php if($_GET["id"]== 0){echo "1&pg=adminFiche";}else{echo "2&pg=formFiche";}?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <input name="date_creation" type="hidden" id="id" value="<?php if ($_GET["id"]!= 0){echo $fiche->getDate_creation();}?>"/>
                                     <input name="type" type="hidden" id="id" value="1"/>
                                 ...
                                 <select id="e1" style="width:300px" class="populate " name="mois" required="">
                                    ...
                                    if($_GET['id']!=0)
                                    {
                                    	...
                                    	if(isset($filee) && !empty($filee)){
                                    		...
                                    		<a href="../abcs@123Session/documents/'.$client->getMatricule().'/'.$filee.'" target="_blank"><img src="assets/images/pdf2.png" style="width: 50px;"/></a>';
                                    		echo ' <a href="controller/fiche_save.php?idMod='.$_GET['id'].'&op=5&pg=formFiche" style="color:#FFF;"><i class="fa fa-trash"></i> Supprimer</a>';
                                    		echo '<div>';
                                    	}
                                    }
                                     ?>
